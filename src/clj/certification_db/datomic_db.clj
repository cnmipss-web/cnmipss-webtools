;; (ns certification-db.datomic-db
...
;; (def ^:private email->id '[:find ?e :in $ ?email
;;                            :where [?e :user/email ?email]])

;; (def ^:private email->type '[:find ?type :in $ ?email
;;                              :where [?e :user/email ?email] [?e :user/type ?type]])

;; (def ^:private email->token '[:find ?token :in $ ?email
;;                               :where [?e :user/email ?email] [?e :user/token ?token]])
